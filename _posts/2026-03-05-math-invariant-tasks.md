---
layout: post
title:  "Инвариант четности суммы и произведения. Часть 1"
...
<details close>
  <summary style="font-style: italic;">Подсказка</summary>
...
В следующей статье будем разбирать задачи, где инвариантом является четность произведения.